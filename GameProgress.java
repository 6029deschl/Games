...
public class GameProgress extends Application {
	...
	private void constructWorld(Group root) {
		...
		final PhongMaterial caveMaterial = new PhongMaterial();
		caveMaterial.setDiffuseColor(Color.BLACK);
		rectangle2 = new Box(30, 40, 30);
		rectangle2.setMaterial(caveMaterial);

		rectangle2.setTranslateX(bx);
		rectangle2.setTranslateY(by);
		rectangle2.setTranslateZ(810);

		root.getChildren().addAll(spinner, box3, rectangle, rectangle2);// sphere3, sphere2, sphere, cylinder);
